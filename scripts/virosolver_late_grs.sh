...
R CMD BATCH --quiet --no-restore --no-save code/virosolver_late_grs_cluster.R jobout/${SLURM_JOB_NAME}/virosolver_late_grs_${SLURM_ARRAY_TASK_ID}.Rout
